document.addEventListener('DOMContentLoaded', function() {
    const toggleBtn = document.getElementById('show-hiragana-library-toggle');
    const libraryContainer = document.getElementById('hiragana-library');
    ...
    toggleBtn.addEventListener('click', function() {
        if (libraryContainer.style.display === 'none' || libraryContainer.style.display === '') {
            ...
            toggleBtn.textContent = '나만의 히라가나 도서관 닫기';
        } else {
            libraryContainer.style.display = 'none';
            toggleBtn.textContent = '나만의 히라가나 도서관 보기';
        }
    });
